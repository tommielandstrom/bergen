...
<section id="comments" class="comments-area">
	...
	<h3 class="comments-title">
		<?php
			printf( _n('One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(),'felles'),
	...
	<nav id="comment-nav-below" class="navigation comment-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e('Comment navigation','felles'); ?></h1>
		<div class="nav-previous"><?php previous_comments_link(__('&larr; Older Comments','felles')); ?></div>
		<div class="nav-next"><?php next_comments_link(__('Newer Comments &rarr;','felles')); ?></div>
	</nav>
	<?php endif; // Check for comment navigation. ?>

	<?php if (! comments_open()) : ?>
	<p class="no-comments"><?php _e('Comments are closed.','felles'); ?></p>
	<?php endif; ?>
	...
	<?php endif; // have_comments() ?>
			...
			<?php // You can modify the comments form to suit your needs here. Please refer to http://codex.wordpress.org/Function_Reference/comment_form as well as http://codex.wordpress.org/Function_Reference/comments_template
			  ...
			  'id_form'           => 'commentform',
			  'id_submit'         => 'submit',
			  'title_reply'       => __( 'Leave a Reply', 'felles' ),
			  'title_reply_to'    => __( 'Leave a Reply to %s', 'felles' ),
			  'cancel_reply_link' => __( 'Cancel Reply', 'felles' ),
			  'label_submit'      => __( 'Post Comment', 'felles' ),

			  'comment_field' =>  '<p class="comment-form-comment"><label for="comment">' . __( 'Comment', 'felles' ) .
			  ...
			  'comment_notes_before' => '<p class="comment-notes">' .
			    __( 'Your email address will not be published.', 'felles' ) . ( $req ? $required_text : '' ) . '</p>',
